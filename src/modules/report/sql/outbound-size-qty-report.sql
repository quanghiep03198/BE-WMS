WITH datalist AS (
	SELECT EPC_Code, mo_no, rfid_status, record_time, FC_server_code, stationNO FROM DV_DATA_LAKE.dbo.dv_InvRFIDrecorddet
	UNION ALL 
	SELECT EPC_Code, mo_no, rfid_status, record_time, FC_server_code, stationNO 
