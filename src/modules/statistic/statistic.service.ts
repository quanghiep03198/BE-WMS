...
import { RFIDInventoryBackupEntity } from '../finished-goods/infrastructure/persistence/mssql/entities/rfid-inventory.entity'
...
export class StatisticService {
	...
	public async getLastSixMonthsNetFlow() {
		const inboundCte = this.dataSource
			...
			.andWhere(/* SQL */ `RIGHT(stationNO, 3) = '101'`)
