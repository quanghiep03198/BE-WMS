...
export class BulkWriteInboundEpcsQueueEvents extends QueueEventsHost {
	constructor(@InjectPinoLogger(BulkWriteInboundEpcsQueueEvents.name) private readonly logger: PinoLogger) {
		super()
	}
