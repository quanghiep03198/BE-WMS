...
export class ExchangeMoSuccessHandler implements IEventHandler<ExchangeMoSuccessEvent> {
	constructor(@InjectPinoLogger(ExchangeMoSuccessHandler.name) private readonly logger: PinoLogger) {}
