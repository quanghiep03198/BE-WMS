...
import { CACHE_SERVICE, REDIS_CLIENT, REDIS_PUBLISHER, REDIS_SUBSCRIBER } from '../constants'
...
export const InjectCacheService = (): ParameterDecorator => Inject(CACHE_SERVICE)
